        ...
        if (data[i].children !== undefined && data[i].children.length > 0) {
            ...
            for (var j = 0; j < data[i].children.length; j++) {
                if (data[i].children[j].target === "_blank") {
                    ulHtml += '<dd><a href="javascript:;" style="font-size: 20px" data-url="' + data[i].children[j].url + '" target="' + data[i].children[j].target + '">';
                } else {
                    ulHtml += '<dd><a href="javascript:;" style="font-size: 20px" data-url="' + data[i].children[j].url + '">';
                }
